  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {loading ? (
          <div className="col-span-3 text-center py-8 text-gray-400">Cargando...</div>
        ) : practicas.length === 0 ? (
          <div className="col-span-3 text-center py-8 text-gray-400">No tienes practicantes asignados aún.</div>
        ) : practicas.map(p => (
